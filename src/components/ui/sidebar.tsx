...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-transparent dark:bg-transparent w-[300px] shrink-0 mt-22",
        className
      )}
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              ...
              <div className="mt-12">{/* children inserted here manually */}</div>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
